...
void CanvasView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->strokeCompleted((*reinterpret_cast<std::add_pointer_t<Stroke>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CanvasView::*)(const Stroke & )>(_a, &CanvasView::strokeCompleted, 0))
            return;
    }
}
...
// SIGNAL 0
void CanvasView::strokeCompleted(const Stroke & _t1)
{
